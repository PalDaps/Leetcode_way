...
Идея: Выбираем, что меньше и добавляем в результирующий линкед лист. Если закончились оба, то возвращаем результирующий сортед линкед лист.
Если закончился первый, то отсавшаяся второго листа добавляется в результирущий. Аналогично, если закончился второй.
