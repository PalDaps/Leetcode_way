...
/*
»де€: пройтись по массиву. ≈сли видим 0 то, добавл€ем к счетчику нулей, если видим не ноль, 
то записываем элемент последовательно с начала.  оличество нулей записываем впритык под конец.
*/
