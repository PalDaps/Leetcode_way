...
«адача: Ќайти всем локальные максимумы матри 3*3 в большой матрице.

»де€: ѕо факту просто найти локальный максимум в матрице 3*3.

P.S. 22:29 «адача механически сложна€, не помню как создавать двумерный вектор и итераци€ по нему тоже не сразу
